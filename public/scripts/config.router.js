        ...
        $urlRouterProvider
          .otherwise('/access/signup');
            ...
            .state('app.analysis', {
              ...
              data : { title: 'Analysis' , folded: true},
              controller : 'advertiserController',
              resolve: load(['scripts/controllers/frontend/advertiserController.js'])
            })
            .state('app.advertiser', {
              url: '/advertiser',
              templateUrl: 'views/pages/advertiser.html',
              data : { title: 'Advertiser', folded: true },
              controller : 'advertiserController',
              resolve: load(['scripts/controllers/frontend/advertiserController.js']) 
            })
            .state('app.editAdvertiser', {
              url: '/editAdvertiser/:id',
              templateUrl: 'views/pages/updateAdvertiser.html',
              data : { title: 'Advertiser', folded: true },
              controller : 'advertiserController',
              resolve: load(['scripts/controllers/frontend/advertiserController.js']) 
            })            
